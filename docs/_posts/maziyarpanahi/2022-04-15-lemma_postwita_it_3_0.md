...
Pretrained Lemmatizer model (`lemma_postwita`) trained on Universal Dependencies 2.9 (UD_Italian-PoSTWITA) in Italian language.
...
[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/lemma_postwita_it_3.4.3_3.0_1650038072699.zip){:.button.button-orange.button-orange-trans.arr.button-icon}
